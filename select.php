...
<body>
  ...
  <div class="w3-container  w3-blue ">
   <br>
    ...
    <p align="right" class="back">  <a href="view.php" class="w3-button w3-green">View</a>  &nbsp;
    
             &nbsp; 
              <a href="index.php" class="w3-button w3-green">Back</a>
...
<?php 
	...
	$sql="select * from scientist_information where confirm=0";
...
<td><label><?php echo $row["id_num"]; ?></td> 
 ...
 <td><label><?php echo $row["Work_option3"]; ?></td>
  ...
  <td><input type="submit"  class="w3-button w3-blue" name="b2" value="ADD">
 </td>
  <td><input type="submit"  class="w3-button w3-black"name="b3" value="DELETE">
 </td>
  
 </form>
 <td>
 <form method="post" action="genratepdf.php">
<input type="hidden" name="mail_id" value="<?php echo $row["Email"];?>">
<input type="submit" class="w3-button w3-red"name="b1" value="VIEW">
 </form></td>
</tr>
<?php
   }
